...
class CompanyInsiderSignal(models.Model):
    ...
    insider_signal = models.CharField(
        max_length=20, blank=True, choices=INSIDER_SIGNAL_CHOICES
    )
    ...
    institutional_change_qoq = models.DecimalField(
        max_digits=8, decimal_places=4, null=True, blank=True
    )
    top_holder_action = models.CharField(
        max_length=20, blank=True, choices=HOLDER_ACTION_CHOICES
    )
    ...
    short_interest_change = models.CharField(
        max_length=20, blank=True, choices=CHANGE_CHOICES
    )
    ...
    # 종합
    smart_money_signal = models.CharField(
        max_length=20, blank=True, choices=SMART_MONEY_CHOICES
    )
