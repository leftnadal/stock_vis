...
class CompanySensitivityProfile(models.Model):
    ...
    debt_maturity_risk = models.CharField(
    ...
    # 환율 민감도
    foreign_revenue_pct = models.DecimalField(
    ...
    beta_sector_adj = models.DecimalField(
    ...
    regulation_type = models.CharField(
        max_length=50, blank=True, choices=REGULATION_CHOICES
    )
