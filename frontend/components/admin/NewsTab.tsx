...
import { NewsPipelineSubTab } from './news/NewsPipelineSubTab';
...
export default function NewsTab() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-1 border-b border-gray-200 dark:border-gray-700 pb-0">
        <button
          ...
          className={`px-4 py-2 text-sm font-medium rounded-t-lg transition-colors ${
            subTab === 'overview'
              ? 'bg-white dark:bg-gray-800 text-blue-600 dark:text-blue-400 border border-b-white dark:border-gray-700 dark:border-b-gray-800 border-b-0 -mb-px'
      ...
      {subTab === 'pipeline' && <NewsPipelineSubTab enabled={subTab === 'pipeline'} />}
    </div>
  );
}
