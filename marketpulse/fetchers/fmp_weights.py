...
def _request_etf_holder(etf_symbol: str, *, timeout: float = 10.0) -> list[dict[str, Any]]:
    ...
    if not isinstance(payload, list):
        raise ValueError(f'unexpected FMP etf/holdings payload type: {type(payload).__name__}')
    return payload
