...
class BreadthSnapshot(models.Model):
    ...
    universe = models.CharField(max_length=10, choices=Universe.choices, default=Universe.SPY)
...
class SectorFlowSnapshot(models.Model):
    ...
    rel_strength = models.DecimalField(max_digits=10, decimal_places=6, default=Decimal('0'))
    momentum_1d = models.DecimalField(max_digits=10, decimal_places=6, default=Decimal('0'))
    momentum_5d = models.DecimalField(max_digits=10, decimal_places=6, default=Decimal('0'))
    momentum_20d = models.DecimalField(max_digits=10, decimal_places=6, default=Decimal('0'))

    flow_proxy = models.DecimalField(max_digits=18, decimal_places=2, default=Decimal('0'))

    cross_dispersion = models.DecimalField(max_digits=10, decimal_places=6, default=Decimal('0'))
    rotation_index = models.DecimalField(max_digits=10, decimal_places=6, default=Decimal('0'))
...
class ConcentrationSnapshot(models.Model):
    ...
    top5_weight = models.DecimalField(max_digits=6, decimal_places=4, default=Decimal('0'))
    top10_weight = models.DecimalField(max_digits=6, decimal_places=4, default=Decimal('0'))
    ...
    def clean(self) -> None:
        ...
        if self.top5_weight > self.top10_weight:
            raise ValidationError({'top5_weight': 'top5_weight must be ≤ top10_weight.'})
