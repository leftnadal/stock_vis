...
urlpatterns = [
    ...
    # ========================================
    path(
        "admin/dashboard/overview/", AdminOverviewView.as_view(), name="admin-overview"
    ),
    path("admin/dashboard/stocks/", AdminStocksView.as_view(), name="admin-stocks"),
    path(
        "admin/dashboard/screener/", AdminScreenerView.as_view(), name="admin-screener"
    ),
    path(
        "admin/dashboard/market-pulse/",
        AdminMarketPulseView.as_view(),
        name="admin-market-pulse",
    ),
    ...
    path(
        "admin/dashboard/actions/status/<str:task_id>/",
        AdminTaskStatusView.as_view(),
        name="admin-task-status",
    ),
    path(
        "admin/dashboard/news/categories/",
        AdminNewsCategoryView.as_view(),
        name="admin-news-categories",
    ),
    path(
        "admin/dashboard/news/categories/<int:category_id>/",
        AdminNewsCategoryDetailView.as_view(),
        name="admin-news-category-detail",
    ),
    path(
        "admin/dashboard/news/sector-options/",
        AdminNewsSectorOptionsView.as_view(),
        name="admin-news-sector-options",
    ),
    # ========================================
    # Market Movers
    # ========================================
    ...
    path(
        "keywords/generate-all",
        views.trigger_keyword_generation,
        name="generate-keywords",
    ),
    path(
        "keywords/generate-screener",
        views.generate_screener_keywords,
        name="generate-screener-keywords",
    ),
    ...
    path(
        "breadth/history", views.market_breadth_history, name="market-breadth-history"
    ),
    ...
    path(
        "heatmap/sectors/<str:sector>/stocks",
        views.sector_stocks_api,
        name="sector-stocks",
    ),
    ...
    path(
        "presets/shared/<str:share_code>",
        views.get_shared_preset,
        name="get-shared-preset",
    ),
    path("presets/import/<str:share_code>", views.import_preset, name="import-preset"),
    path(
        "presets/<int:preset_id>",
        views.screener_preset_detail,
        name="screener-preset-detail",
    ),
    path(
        "presets/<int:preset_id>/execute", views.execute_preset, name="execute-preset"
    ),
    ...
    path(
        "alerts/history/<int:history_id>/read",
        views.mark_alert_read,
        name="mark-alert-read",
    ),
    path(
        "alerts/history/<int:history_id>/dismiss",
        views.dismiss_alert,
        name="dismiss-alert",
    ),
    path(
        "alerts/<int:alert_id>",
        views.screener_alert_detail,
        name="screener-alert-detail",
    ),
    ...
    path(
        "thesis/shared/<str:share_code>",
        views.get_shared_thesis,
        name="get-shared-thesis",
    ),
    ...
    # ========================================
    path(
        "llm-relations/extract",
        views.extract_relations_from_news_api,
        name="llm-relations-extract",
    ),
    path("llm-relations/sync", views.sync_llm_relations_api, name="llm-relations-sync"),
    path(
        "llm-relations/stats", views.llm_relations_stats_api, name="llm-relations-stats"
    ),
    path(
        "llm-relations/<str:symbol>",
        views.get_llm_relations_api,
        name="llm-relations-get",
    ),
    # ========================================
    ...
    path(
        "institutional/<str:symbol>/peers",
        views.institutional_peers_api,
        name="institutional-peers",
    ),
    path(
        "institutional/<str:symbol>",
        views.institutional_holdings_api,
    ...
    # ========================================
    path(
        "regulatory/<str:symbol>",
        views.get_regulatory_relations_api,
        name="regulatory-get",
    ),
    path(
        "patent-network/<str:symbol>",
        views.get_patent_relations_api,
        name="patent-network-get",
    ),
    # ========================================
    # Health Check
    # ========================================
