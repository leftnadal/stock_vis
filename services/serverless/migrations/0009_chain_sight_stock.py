    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "expires_at",
                    models.DateTimeField(help_text="캐시 만료 시점 (생성일 + 24시간)"),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["symbol", "date"], name="serverless__symbol_ccb3c6_idx"
                    ),
                    models.Index(
                        fields=["expires_at"], name="serverless__expires_e17cf3_idx"
                    ),
                ],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["source_symbol", "relationship_type"],
                        name="serverless__source__5eed49_idx",
                    ),
                    models.Index(
                        fields=["target_symbol", "relationship_type"],
                        name="serverless__target__df767b_idx",
                    ),
                    models.Index(
                        fields=["source_symbol", "-strength"],
                        name="serverless__source__5676c7_idx",
                    ),
                ],
                "unique_together": {
