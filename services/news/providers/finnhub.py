...
class FinnhubNewsProvider(BaseNewsProvider):
    ...
    def _make_request(self, endpoint: str, params: Dict[str, str]) -> Dict[str, Any]:
        ...
        logger.info(f"Making request to Finnhub: {url} with params: {safe_params}")
    ...
    def fetch_company_news(
        ...
        try:
            ...
            logger.info(
                f"Fetched {len(articles)} company news for {symbol} from Finnhub"
            )
            return articles
    ...
    def fetch_market_news(
        ...
        try:
            ...
            logger.info(
                f"Fetched {len(articles)} market news for category '{category}' from Finnhub"
            )
            return articles
    ...
    def _parse_article(
        self, item: Dict[str, Any], symbol: str = None, category: str = "general"
    ) -> RawNewsArticle:
        """
