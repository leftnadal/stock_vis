...
class DataBasketAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("기본 정보", {"fields": ("user", "name", "description")}),
        (
            "메타 정보",
...
class BasketItemAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("기본 정보", {"fields": ("basket", "item_type", "reference_id")}),
        ("표시 정보", {"fields": ("title", "subtitle")}),
        (
            "데이터 스냅샷",
            {"fields": ("data_snapshot", "snapshot_date"), "classes": ("collapse",)},
        ),
...
class AnalysisSessionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("기본 정보", {"fields": ("user", "basket", "status", "title")}),
        ("탐험 경로", {"fields": ("exploration_path",), "classes": ("collapse",)}),
        (
            "메타 정보",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class AnalysisMessageAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("기본 정보", {"fields": ("session", "role", "content")}),
        ("LLM 제안", {"fields": ("suggestions",), "classes": ("collapse",)}),
        ("토큰 사용량", {"fields": ("input_tokens", "output_tokens")}),
        ("메타 정보", {"fields": ("created_at",), "classes": ("collapse",)}),
    )
