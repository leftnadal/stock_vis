...
class TestGraphRAGScorer:
    ...
    def mock_neo4j_service(self):
        ...
        mock.get_stock_relationships.return_value = {
            ...
            "competitors": [{"symbol": "MSFT", "overlap_score": 0.7}],
            "sector_peers": [],
    ...
    def scorer(self, mock_reranker, mock_neo4j_service):
        """GraphRAGScorer 인스턴스"""
        return GraphRAGScorer(reranker=mock_reranker, neo4j_service=mock_neo4j_service)
    ...
    def test_score_basic(self, scorer, sample_documents, mock_reranker):
        """기본 스코어링 동작"""
        result = scorer.score(
            question="AAPL 분석", documents=sample_documents, symbol="AAPL", top_k=3
        )
    ...
    def test_integrate_scores(self, scorer, mock_reranker):
        ...
        result = scorer._integrate_scores(
            reranked, graph_scores, recency_scores, top_k=2
        )
...
class TestGraphRAGScorerIntegration:
    ...
    def full_scorer(self):
        ...
        return GraphRAGScorer(reranker=mock_reranker, neo4j_service=mock_neo4j)
