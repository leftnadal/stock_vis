...
class DataBasketAPITest(TestCase):
    ...
    def test_basket_create(self):
        ...
        url = reverse("rag_analysis:basket-list-create")
        payload = {"name": "Tech Analysis", "description": "Tech sector stocks"}
    ...
    def test_basket_detail(self):
        ...
        basket = DataBasket.objects.create(user=self.user, name="Test Basket")
        BasketItem.objects.create(
            basket=basket, item_type="stock", reference_id="AAPL", title="Apple Inc."
        )
    ...
    def test_basket_detail_not_owner(self):
        ...
        basket = DataBasket.objects.create(user=self.other_user, name="Other Basket")
    ...
    def test_basket_update(self):
        ...
        basket = DataBasket.objects.create(user=self.user, name="Old Name")
    ...
    def test_basket_delete(self):
        ...
        basket = DataBasket.objects.create(user=self.user, name="To Delete")
...
class BasketItemAPITest(TestCase):
    ...
    def test_add_item_duplicate(self):
        ...
        # 같은 아이템 추가 시도
        url = reverse("rag_analysis:basket-add-item", kwargs={"pk": self.basket.pk})
        payload = {"item_type": "stock", "reference_id": "AAPL", "title": "Apple Inc."}
    ...
    def test_remove_item_success(self):
        ...
        url = reverse(
            "rag_analysis:basket-remove-item",
            kwargs={"pk": self.basket.pk, "item_id": item.pk},
        )
        response = self.client.delete(url)
    ...
    def test_remove_item_not_found(self):
        ...
        url = reverse(
            "rag_analysis:basket-remove-item",
            kwargs={"pk": self.basket.pk, "item_id": 9999},
        )
        response = self.client.delete(url)
...
class AnalysisSessionAPITest(TestCase):
    ...
    def test_session_list_authenticated(self):
        ...
        AnalysisSession.objects.create(
            user=self.user, basket=self.basket, title="Session 1"
        )
        AnalysisSession.objects.create(
            user=self.user, basket=self.basket, title="Session 2"
        )
        AnalysisSession.objects.create(
            user=self.other_user, basket=None, title="Other Session"
        )
    ...
    def test_session_create_with_basket(self):
        """바구니와 함께 세션 생성 테스트"""
        url = reverse("rag_analysis:session-list-create")
        payload = {"basket_id": self.basket.pk, "title": "Tech Analysis Session"}
    ...
    def test_session_create_without_basket(self):
        """바구니 없이 세션 생성 테스트"""
        url = reverse("rag_analysis:session-list-create")
        payload = {"title": "General Analysis"}
    ...
    def test_session_create_invalid_basket(self):
        ...
        other_basket = DataBasket.objects.create(
            user=self.other_user, name="Other Basket"
        )

        url = reverse("rag_analysis:session-list-create")
        payload = {"basket_id": other_basket.pk, "title": "Invalid Session"}
    ...
    def test_session_detail(self):
        ...
        AnalysisMessage.objects.create(
            session=session, role="user", content="Test question"
        )
    ...
    def test_session_delete(self):
        """세션 삭제 테스트"""
        session = AnalysisSession.objects.create(
            user=self.user, basket=self.basket, title="To Delete"
        )
...
class ErrorResponseFormatTest(TestCase):
    ...
    def test_basket_full_error_code(self):
        ...
        payload = {"item_type": "stock", "reference_id": "TEST16", "title": "Test 16"}
    ...
    def test_duplicate_item_error_code(self):
        ...
        basket = DataBasket.objects.create(user=self.user, name="Test")
        BasketItem.objects.create(
            basket=basket, item_type="stock", reference_id="AAPL", title="Apple"
        )

        # 중복 추가 시도
        url = reverse("rag_analysis:basket-add-item", kwargs={"pk": basket.pk})
        payload = {"item_type": "stock", "reference_id": "AAPL", "title": "Apple"}
    ...
    def test_invalid_input_error_code(self):
        ...
        url = reverse("rag_analysis:basket-add-item", kwargs={"pk": basket.pk})
        payload = {"item_type": "invalid_type", "reference_id": "TEST", "title": "Test"}
...
class ConcurrencyTest(TestCase):
    ...
    def test_concurrent_item_addition_prevented(self):
        ...
        payload1 = {"item_type": "stock", "reference_id": "TEST14", "title": "Test 14"}
        payload2 = {"item_type": "stock", "reference_id": "TEST15", "title": "Test 15"}
