...
class EODNewsEnricher:
    ...
    def enrich(self, tagged_signals: list[dict], target_date: date) -> list[dict]:
        ...
        for item in tagged_signals:
            ...
            signal_direction = (
                signals[0].get("direction", "neutral") if signals else "neutral"
            )
    ...
    def _find_news(
        ...
        if industry:
            ...
            if news:
                return self._build_news_dict(
                    news, "industry_7d", "context", target_date
                )
    ...
    def _build_news_dict(
        ...
        published_date = (
            ...
            if hasattr(news.published_at, "date")
            else target_date
        )
    ...
    def _adjust_confidence(
        ...
        directions_match = (
            sentiment == "positive" and signal_direction == "bullish"
        ) or (sentiment == "negative" and signal_direction == "bearish")
        directions_conflict = (
            sentiment == "positive" and signal_direction == "bearish"
        ) or (sentiment == "negative" and signal_direction == "bullish")
