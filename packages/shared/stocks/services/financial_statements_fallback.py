            ...
            result.append(
                {
                    ...
                    "period_type": "quarter"
                    if item.get("period", "").startswith("Q")
                    else "annual",
                    "currency": item.get("reportedCurrency", "USD"),
                    "total_assets": self._safe_float(item.get("totalAssets")),
                    "total_current_assets": self._safe_float(
                        item.get("totalCurrentAssets")
                    ),
                    "cash_and_cash_equivalents": self._safe_float(
                        item.get("cashAndCashEquivalents")
                    ),
                    "short_term_investments": self._safe_float(
                    ...
                    "total_non_current_assets": self._safe_float(
                        item.get("totalNonCurrentAssets")
                    ),
                    "property_plant_equipment": self._safe_float(
                    ...
                    "long_term_investments": self._safe_float(
                        item.get("longTermInvestments")
                    ),
                    "total_liabilities": self._safe_float(item.get("totalLiabilities")),
                    "total_current_liabilities": self._safe_float(
                    ...
                    "total_non_current_liabilities": self._safe_float(
                        item.get("totalNonCurrentLiabilities")
                    ),
                    "long_term_debt": self._safe_float(item.get("longTermDebt")),
                    "total_shareholder_equity": self._safe_float(
            ...
            result.append(
                {
                    ...
                    "operating_expenses": self._safe_float(
                        item.get("operatingExpenses")
                    ),
                    "research_and_development": self._safe_float(
                        item.get("researchAndDevelopmentExpenses")
                    ),
                    "selling_general_administrative": self._safe_float(
                    ...
                    "income_tax_expense": self._safe_float(
            ...
            result.append(
                {
                    ...
                    "net_income": self._safe_float(item.get("netIncome")),
                    "depreciation_and_amortization": self._safe_float(
                        item.get("depreciationAndAmortization")
                    ),
                    "stock_based_compensation": self._safe_float(
                        item.get("stockBasedCompensation")
                    ),
                    "change_in_working_capital": self._safe_float(
                        item.get("changeInWorkingCapital")
                    ),
                ...
                result.append(
                    {
                        ...
                        "operating_expenses": get_val(
                            ["Operating Expense", "Total Operating Expenses"]
                        ),
                        "research_and_development": get_val(
                            ["Research And Development"]
                        ),
                        "selling_general_administrative": get_val(
                ...
                result.append(
                    {
                        ...
                        "depreciation_and_amortization": get_val(
                            ["Depreciation And Amortization"]
                        ),
                        "stock_based_compensation": get_val(
                            ["Stock Based Compensation"]
                        ),
                        "change_in_working_capital": get_val(
