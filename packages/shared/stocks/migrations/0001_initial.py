    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["industry"], name="stocks_stoc_industr_f83c5c_idx"
                    ),
                    models.Index(
                        fields=["market_capitalization"],
                        name="stocks_stoc_market__dfade5_idx",
                    ),
                    models.Index(
                    ...
                    models.Index(
                        ...
                        name="stocks_stoc_symbol_001729_idx",
                    ),
                    models.Index(
                        fields=["real_time_price"],
                        name="stocks_stoc_real_ti_7a2280_idx",
                    ),
                ],
            },
        ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="stocks_inco_stock_i_892024_idx",
                    ),
                    models.Index(
                        fields=["period_type", "fiscal_year"],
                        name="stocks_inco_period__f37249_idx",
                    ),
                ],
                "unique_together": {
                    ("stock", "period_type", "fiscal_year", "fiscal_quarter")
                },
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["stock", "date"], name="stocks_dail_stock_i_1e5613_idx"
                    ),
                    models.Index(
                        fields=["date", "volume"], name="stocks_dail_date_85d705_idx"
                    ),
                    models.Index(
                        fields=["stock", "-date"], name="stocks_dail_stock_i_5c51bc_idx"
                    ),
                ],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["stock", "fiscal_year"],
                        name="stocks_cash_stock_i_5d7422_idx",
                    ),
                    models.Index(
                        fields=["period_type", "fiscal_year"],
                        name="stocks_cash_period__e67df9_idx",
                    ),
                ],
                "unique_together": {
                    ("stock", "period_type", "fiscal_year", "fiscal_quarter")
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["stock", "fiscal_year"],
                        name="stocks_bala_stock_i_393052_idx",
                    ),
                    models.Index(
                        fields=["period_type", "fiscal_year"],
                        name="stocks_bala_period__82b5a8_idx",
                    ),
                ],
                "unique_together": {
                    ("stock", "period_type", "fiscal_year", "fiscal_quarter")
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["stock", "date"], name="stocks_week_stock_i_1a3c5d_idx"
                    ),
                    models.Index(
                        fields=["stock", "-date"], name="stocks_week_stock_i_f8dbef_idx"
                    ),
                ],
                "unique_together": {("stock", "date")},
            },
