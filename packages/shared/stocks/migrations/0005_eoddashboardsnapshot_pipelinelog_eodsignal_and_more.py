    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["-date", "status"], name="stocks_pipe_date_3c8702_idx"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["date", "-composite_score"],
                        name="stocks_eod__date_620945_idx",
                    ),
                    models.Index(
                        fields=["date", "-signal_count"],
                        name="stocks_eod__date_dda178_idx",
                    ),
                    models.Index(
                        fields=["stock", "-date"], name="stocks_eod__stock_i_477304_idx"
                    ),
                    models.Index(
                        fields=["date", "sector"], name="stocks_eod__date_d4225b_idx"
                    ),
                ],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["signal_date", "signal_tag"],
                        name="stocks_sign_signal__284e24_idx",
                    )
                ],
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="stocks_stoc_symbol_ea398f_idx",
                    ),
                    models.Index(
                        fields=["sector", "-published_at"],
                        name="stocks_stoc_sector_54dd87_idx",
                    ),
                    models.Index(
                        fields=["industry", "-published_at"],
                        name="stocks_stoc_industr_e03659_idx",
                    ),
                    models.Index(
                        fields=["-published_at"], name="stocks_stoc_publish_c66d9f_idx"
                    ),
                ],
            },
        ),
