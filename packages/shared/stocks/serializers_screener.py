...
class ScreenedStockSerializer(serializers.Serializer):
    ...
    exchange_short_name = serializers.CharField(
        source="exchangeShortName", allow_null=True, required=False
    )
    ...
    changes_percentage = serializers.FloatField(
        source="changesPercentage", allow_null=True, required=False
    )
    last_annual_dividend = serializers.FloatField(
        source="lastAnnualDividend", allow_null=True, required=False
    )
    previous_close = serializers.FloatField(
        source="previousClose", allow_null=True, required=False
    )
    ...
    is_actively_trading = serializers.BooleanField(
        source="isActivelyTrading", default=True, required=False
    )
...
class ScreenerRequestSerializer(serializers.Serializer):
    ...
    market_cap_more_than = serializers.IntegerField(
        required=False, allow_null=True, min_value=0, help_text="최소 시가총액 (USD)"
    )
    market_cap_lower_than = serializers.IntegerField(
        required=False, allow_null=True, min_value=0, help_text="최대 시가총액 (USD)"
    )

    # 가격 필터
    price_more_than = serializers.FloatField(
        required=False, allow_null=True, min_value=0, help_text="최소 주가 (USD)"
    )
    price_lower_than = serializers.FloatField(
        required=False, allow_null=True, min_value=0, help_text="최대 주가 (USD)"
    )

    # 베타 필터
    beta_more_than = serializers.FloatField(
        required=False, allow_null=True, help_text="최소 베타"
    )
    beta_lower_than = serializers.FloatField(
        required=False, allow_null=True, help_text="최대 베타"
    )

    # 거래량 필터
    volume_more_than = serializers.IntegerField(
        required=False, allow_null=True, min_value=0, help_text="최소 거래량"
    )
    volume_lower_than = serializers.IntegerField(
        required=False, allow_null=True, min_value=0, help_text="최대 거래량"
    )

    # 배당 필터
    dividend_more_than = serializers.FloatField(
        required=False, allow_null=True, min_value=0, help_text="최소 배당률 (%)"
    )
    dividend_lower_than = serializers.FloatField(
        required=False, allow_null=True, min_value=0, help_text="최대 배당률 (%)"
    )

    # 기타 필터
    is_etf = serializers.BooleanField(
        required=False, allow_null=True, help_text="ETF 여부"
    )
    is_actively_trading = serializers.BooleanField(
        required=False, default=True, help_text="활성 거래 종목만"
    )
    sector = serializers.CharField(
        required=False, allow_null=True, max_length=100, help_text="섹터 필터"
    )
    industry = serializers.CharField(
        required=False, allow_null=True, max_length=100, help_text="산업 필터"
    )
    ...
    pe_ratio_min = serializers.FloatField(
        required=False, allow_null=True, help_text="최소 PER (Enhanced)"
    )
    pe_ratio_max = serializers.FloatField(
        required=False, allow_null=True, help_text="최대 PER (Enhanced)"
    )
    roe_min = serializers.FloatField(
        required=False, allow_null=True, help_text="최소 ROE (%) (Enhanced)"
    )
    roe_max = serializers.FloatField(
        required=False, allow_null=True, help_text="최대 ROE (%) (Enhanced)"
    )
    eps_growth_min = serializers.FloatField(
        required=False, allow_null=True, help_text="최소 EPS 성장률 (%) (Enhanced)"
    )
    eps_growth_max = serializers.FloatField(
        required=False, allow_null=True, help_text="최대 EPS 성장률 (%) (Enhanced)"
    )
    revenue_growth_min = serializers.FloatField(
        required=False, allow_null=True, help_text="최소 매출 성장률 (%) (Enhanced)"
    )
    revenue_growth_max = serializers.FloatField(
        required=False, allow_null=True, help_text="최대 매출 성장률 (%) (Enhanced)"
    )
    debt_equity_max = serializers.FloatField(
        required=False, allow_null=True, help_text="최대 부채비율 (D/E) (Enhanced)"
    )
    current_ratio_min = serializers.FloatField(
        required=False, allow_null=True, help_text="최소 유동비율 (Enhanced)"
    )
    ...
    change_percent_min = serializers.FloatField(
        required=False, allow_null=True, help_text="최소 변동률 (%)"
    )
    change_percent_max = serializers.FloatField(
        required=False, allow_null=True, help_text="최대 변동률 (%)"
    )
    ...
    def validate(self, attrs):
        ...
        if mcap_min is not None and mcap_max is not None and mcap_min > mcap_max:
            errors["market_cap_more_than"] = (
                "최소 시가총액은 최대 시가총액보다 작아야 합니다."
            )
        ...
        if div_min is not None and div_max is not None and div_min > div_max:
            errors["dividend_more_than"] = (
                "최소 배당률은 최대 배당률보다 작아야 합니다."
            )
