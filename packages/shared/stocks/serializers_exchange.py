...
class QuoteSerializer(serializers.Serializer):
    ...
    year_high = serializers.FloatField(
        source="yearHigh", allow_null=True, required=False
    )
    ...
    avg_volume = serializers.IntegerField(
        source="avgVolume", allow_null=True, required=False
    )
    ...
    shares_outstanding = serializers.FloatField(
        source="sharesOutstanding", allow_null=True, required=False
    )
