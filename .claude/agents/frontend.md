...
# 예시
python shared_kb/search.py "useEffect 무한 루프"
python shared_kb/search.py "TanStack Query" --type pattern
python shared_kb/search.py "React Hooks" --type pattern
```
...
# 예시
python shared_kb/search.py "hydration mismatch" --type troubleshoot
python shared_kb/search.py "useQuery refetch"
```
