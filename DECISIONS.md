...
**D-CN-COMPLETE (C-N 백필 종결)**: 전량 완료 122/122창(2026-07-23). SATURATED 2구간(2023-10-30주·12-25주)은 EARLIEST sort 1000 포화에도 일자별 재확인 = 매일 기사 존재(빈날 0) → 실 갭 없음, `--no-skip-covered` 재패스 불요. 완료 후 backfill 재실행 = 대상 0창(전부 skip, AV 0req). ★EARLIEST 절단 보정 원리: 1000행 cap에 걸려도 EARLIEST 정렬이 창 전 일자를 커버하므로 표면 누락이 실 갭 아님.
