...
from apps.portfolio.services.scoring.presets.factor import (
    FACTOR_SPECS,
    FactorScoringEngine,
)
from apps.portfolio.services.scoring.presets.growth import (
    GROWTH_SPECS,
    GrowthScoringEngine,
)
from apps.portfolio.services.scoring.presets.income import (
    INCOME_SPECS,
    IncomeScoringEngine,
)
from apps.portfolio.services.scoring.presets.special import (
    SPECIAL_SPECS,
    SpecialScoringEngine,
)
from apps.portfolio.services.scoring.presets.value import (
    VALUE_SPECS,
    ValueScoringEngine,
)
