    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="관심종목 리스트 이름 (예: 진입준비, 기술주)",
                        max_length=100,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "position_order",
                    models.IntegerField(default=0, help_text="리스트 내 표시 순서"),
                ),
                (
                    "stock",
                    models.ForeignKey(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "-updated_at"], name="users_watch_user_id_b385df_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["watchlist", "position_order"],
                name="users_watch_watchli_a50443_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="watchlistitem",
            index=models.Index(
                fields=["watchlist", "-added_at"], name="users_watch_watchli_6541e9_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="watchlistitem",
