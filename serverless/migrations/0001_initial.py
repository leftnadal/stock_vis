        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "volatility_pct",
                    models.IntegerField(
                        blank=True, help_text="변동성 백분위 (0-100)", null=True
                    ),
                ),
                (
                    "data_quality",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["date", "mover_type"],
                        name="serverless__date_72fd6b_idx",
                    ),
                    models.Index(
                        fields=["symbol", "date"], name="serverless__symbol_def1a6_idx"
                    ),
                ],
