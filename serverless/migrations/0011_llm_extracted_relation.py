    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "source_url",
                    models.URLField(blank=True, help_text="원본 소스 URL", null=True),
                ),
                (
                    "evidence",
                    models.TextField(
                ...
                (
                    "is_verified",
                    models.BooleanField(default=False, help_text="수동 검증 완료 여부"),
                ),
                (
                    "is_synced_to_graph",
                    models.BooleanField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["source_symbol", "relation_type"],
                        name="serverless__source__3f548b_idx",
                    ),
                    models.Index(
                        fields=["target_symbol", "relation_type"],
                        name="serverless__target__45b721_idx",
                    ),
                    models.Index(
                        fields=["extracted_at"], name="serverless__extract_4cb71f_idx"
                    ),
                    models.Index(
                        fields=["is_synced_to_graph", "-extracted_at"],
                        name="serverless__is_sync_87d786_idx",
                    ),
                    models.Index(
                        fields=["confidence", "-llm_confidence_score"],
                        name="serverless__confide_cf7a8a_idx",
                    ),
                ],
                "unique_together": {
