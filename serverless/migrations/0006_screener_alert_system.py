    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_active",
                    models.BooleanField(default=True, help_text="알림 활성화 여부"),
                ),
                (
                    "cooldown_hours",
                    models.IntegerField(
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="마지막 알림 발송 시간", null=True
                    ),
                ),
                (
                    "trigger_count",
                    models.IntegerField(default=0, help_text="총 알림 발송 횟수"),
                ),
                (
                    "notify_in_app",
                    models.BooleanField(default=True, help_text="인앱 알림"),
                ),
                (
                    "notify_email",
                    models.BooleanField(default=False, help_text="이메일 알림"),
                ),
                (
                    "notify_push",
                    models.BooleanField(default=False, help_text="푸시 알림 (PWA)"),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "is_active"], name="serverless__user_id_5c8e1c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="screeneralert",
            index=models.Index(
                ...
                name="serverless__is_acti_a7b3e4_idx",
            ),
        ),
        # AlertHistory model
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "snapshot",
                    models.JSONField(
                        default=dict, help_text="알림 시점 필터 조건 스냅샷"
                    ),
                ),
                (
                    "status",
                ...
                (
                    "read_at",
                    models.DateTimeField(
                        blank=True, help_text="사용자 확인 시간", null=True
                    ),
                ),
                (
                    "dismissed",
                    models.BooleanField(default=False, help_text="알림 해제 여부"),
                ),
                (
                    "alert",
                    models.ForeignKey(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["alert", "-triggered_at"], name="serverless__alert_i_5a8b1f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="alerthistory",
            index=models.Index(
                fields=["triggered_at"], name="serverless__trigger_d2e8a1_idx"
            ),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "preset_ids",
                    models.JSONField(default=list, help_text="사용된 프리셋 IDs"),
                ),
                (
                    "key_metrics",
                    models.JSONField(
                ...
                (
                    "top_picks",
                    models.JSONField(default=list, help_text="추천 종목 (최대 5개)"),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "-created_at"], name="serverless__user_id_9f1b2c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="investmentthesis",
            index=models.Index(
                ...
                name="serverless__is_publ_3e4d5a_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="investmentthesis",
            index=models.Index(
                fields=["share_code"], name="serverless__share_c_7a8b9c_idx"
            ),
        ),
    ]
