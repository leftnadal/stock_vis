...
| SCAN-B2-BE | ② 베이커 보강 — RSI·52주·MA·밸류·퀄리티·베타. 계약 = RECON-VALUATION-R1 실측 + 정칙 ⑶⑷⑺(**shared 위임**) | platform (shared) | RECON-VALUATION-R1 | 🆕 **todo(대기)** | 계약 = R1 실측 후 확정. |
| SCAN-B2-FE | ② 축 칩 점등(B2-BE 착지 후) | @frontend (dashboard) | SCAN-B2-BE | 🆕 **todo(대기)** | |
