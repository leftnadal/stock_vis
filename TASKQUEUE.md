...
| NEWS-MATCH-FIX | 스캐너 실뉴스 매칭 수리 — 방향 ⑴~⑶ 중 **선택=디렉터 결정 대기(OPEN)** | 미배정(방향 후 확정) | RECON-NEWSMATCH-R1(done) | 🆕 **결정 대기(OPEN)** | recon 권고=⑴ 재배선 즉시 검증. SCAN-STORY-LLM 서사 층 선행 제약. common-bugs 채번=수리 착지 세션. |
