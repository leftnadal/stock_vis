...
| CS-S3-1 | M | 묶음(union-find)·제목 인용·8-K 템플릿·story_id 슬러그·헤더 정직화·정렬(사건성 1차)·응답 캐시·window_days·evidence 스키마. FE 카드/헤더/가이드 겹침 | CS-S3-PRE | ✅ **done (커밋 A `ceb270e2` BE·B `ceb3e050` FE·docs C). pytest 814·vitest 16·tsc0·ruff0. ★merge/push/deploy=병진 "푸시" 대기** |
