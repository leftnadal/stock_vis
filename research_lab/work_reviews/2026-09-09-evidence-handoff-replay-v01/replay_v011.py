...
def run_one(spec,config,call,outroot):
 ...
 result={'run_id':rid,'execution_started_at':datetime.datetime.now(datetime.timezone.utc).isoformat(),'harness_version':'0.1.1','spec':spec,'config':config,'status':'running','calls':[],
