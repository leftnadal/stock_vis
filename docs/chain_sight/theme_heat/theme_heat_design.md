...
| C2b 발행 신호 (424B5 일창 수집 + IPO + 계산기)                                       | 마켓 뷰 BE PR             | 1     | ✅ 부분 (2026-07-07, 수집/계산기/커맨드·실FMP 332건 오염0·17 test. 3년 백필·beat 잔여) |
| Heat 8성분 배치(beat) + C8 실구현 + estimates 스냅샷 beat                            | 마켓 뷰 BE PR             | 1     | ☐ (계산기 C1~C7·C2b 완료 → 배치 오케스트레이션·C8 콜드스타트 잔여) |
...
2. ThemeEtfMap·§4.2 오버라이드 초기값 검수 — 소프트 (구현 중 수정 가능).
