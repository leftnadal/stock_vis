...
## §5. KPI 기준선 (Slice 13 Part 5 종결 → Slice 14 진입)

| #   | KPI                | Slice 13 Part 5 종결값        | Slice 14 임계 비고                        |
| --- | ------------------ | ----------------------------- | ----------------------------------------- |
| 1   | 회귀 통과          | **767 passed + 1 skipped**    | Slice 14 임계 별도 결정 (Step 0 진입 시점) |
...
| 5   | 슬라이스 cap       | Step 0~Part 5 모두 $0 (LLM 호출 0) | $1.00 유지                           |
| 6   | LLM 호출           | Step 0~Part 5 **0회** (Slice 13 전체 $0) | 50 유지                        |
| 7   | 4판정 PASS         | N/A (contract test만)         | Slice 14 결정                              |
...
- **Slice 13 누적 회귀 변화**: 668 (시작) → **767 (+99)** ★ 6 commits, $0
