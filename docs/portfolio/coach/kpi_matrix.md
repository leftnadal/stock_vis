...
## §5. KPI 기준선 (Slice 13 Part 3 종결 → Part 4 진입)

| #   | KPI                | Slice 13 Part 3 종결값        | Part 4 임계 비고                          |
| --- | ------------------ | ----------------------------- | ----------------------------------------- |
| 1   | 회귀 통과          | **737 passed + 1 skipped**    | Part 4 +9~13 (표준 슬라이스, §6 참조)     |
...
| 5   | 슬라이스 cap       | Step 0a/0b/Part 1/1.5/2/3 모두 $0 (LLM 호출 0) | $1.00 유지              |
| 6   | LLM 호출           | Step 0~Part 3 0회             | 50 유지                                   |
| 7   | 4판정 PASS         | N/A (contract test만)         | Part 4도 N/A                              |
