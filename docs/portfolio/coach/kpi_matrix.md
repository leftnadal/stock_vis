...
## §5. KPI 기준선 (Slice 13 Step 0b 종결 → Part 1 진입)

| #   | KPI                | Slice 13 Step 0b 종결값       | Part 1 임계 비고                          |
| --- | ------------------ | ----------------------------- | ----------------------------------------- |
| 1   | 회귀 통과          | **707 passed + 1 skipped**    | Part 1 +9~15 (표준 슬라이스, §6 참조)     |
...
| 5   | 슬라이스 cap       | Step 0a/0b 모두 $0 (LLM 호출 0) | $1.00 유지                              |
| 6   | LLM 호출           | Step 0a/0b 0회                | 50 유지                                   |
| 7   | 4판정 PASS         | N/A (Step 0은 manual eval 미실시) | Part 1도 N/A (contract test만)        |
