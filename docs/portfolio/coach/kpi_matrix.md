...
## §5. KPI 기준선 (Slice 13 + #65 종결 → Slice 14 진입)

| #   | KPI                | Slice 13 + #65 종결값          | Slice 14 임계 비고                        |
| --- | ------------------ | ------------------------------ | ----------------------------------------- |
| 1   | 회귀 통과          | **730 passed + 1 skipped**     | Slice 14 임계 별도 결정 (Step 0 진입 시점) |
...
| 5   | 슬라이스 cap       | Step 0~Part 5 + #65 모두 $0 (LLM 호출 0) | $1.00 유지                      |
| 6   | LLM 호출           | Slice 13 전체 + #65 **0회**    | 50 유지                                   |
