...
## §5. KPI 기준선 (Slice 13 Part 2 종결 → Part 3 진입)

| #   | KPI                | Slice 13 Part 2 종결값        | Part 3 임계 비고                          |
| --- | ------------------ | ----------------------------- | ----------------------------------------- |
| 1   | 회귀 통과          | **727 passed + 1 skipped**    | Part 3 +9~13 (표준 슬라이스, §6 참조)     |
...
| 5   | 슬라이스 cap       | Step 0a/0b/Part 1/1.5/2 모두 $0 (LLM 호출 0) | $1.00 유지                |
| 6   | LLM 호출           | Step 0~Part 2 0회             | 50 유지                                   |
| 7   | 4판정 PASS         | N/A (contract test만)         | Part 3도 N/A                              |
