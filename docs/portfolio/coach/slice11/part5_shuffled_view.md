# Slice 11 Part5 — Manual Eval Blind View (D2-A)

**Total cases**: 24, **Seed**: 42

> **평가 가이드**: `manual_eval_rubric.md` 참조 (3축 하이브리드: nat 1~5 / ins 1~5 / actionability OK·NG·N/A)
>
> **blind 유지**: 평가 완료까지 `label_mapping.json` 열지 말 것
>
