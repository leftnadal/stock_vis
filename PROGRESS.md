...
- [ ] **Phase 5 잔여**: (1) PR-CircuitBreaker 7건 (FMP Market Movers / SP500 EOD / Gemini compress / thesis_builder JSON regex 등 fallback 도입) (2) PR-Mobile44pt 9건 (Pagination/IndicatorRow/FilterPanel/MarketGraphCanvas) (3) PR-Pagination/Envelope #14 (응답 래핑 결정 + 21곳 limit 추가, FE 동시 작업 필수)
