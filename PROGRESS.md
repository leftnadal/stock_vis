...
- [ ] Neo4j 28개 잔여 메서드 점진 CB 확장 (`_run_with_cb` 헬퍼 활용, P2 priority — 진입점 sync_from_postgres/sync_all_from_postgres 우선)
- [ ] **Phase 5 잔여**: (1) PR-Mobile44pt 9건 (Pagination/IndicatorRow/FilterPanel/MarketGraphCanvas) (2) PR-Pagination/Envelope #14 (응답 래핑 결정 + 21곳 limit, BE/FE 동시 작업)
