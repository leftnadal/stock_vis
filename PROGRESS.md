...
| `marketpulse-v2` | @backend | Market Pulse v2 Phase 1 + PR-A1 sector_group GICS 12종 + PR-A2 (저위험/중위험/고위험 모두 완료) | +214 | working tree 변경 14개 (커밋 대기) | PR-A3/C/G 진행 또는 정리 후 push |
